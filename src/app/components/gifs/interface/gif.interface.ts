// To parse this data:
//
//   import { Convert, GIFApp } from "./file";
//
//   const gIFApp = Convert.toGIFApp(json);
//
...
export class Convert {
    public static toGIFApp(json: string): GIFApp {
        return cast(JSON.parse(json), r("GIFApp"));
    }

    public static gIFAppToJson(value: GIFApp): string {
        return JSON.stringify(uncast(value, r("GIFApp")), null, 2);
    }
}
